...
- Globally unique
*/}}
{{- define "tempo.crossplane.azure.storageAccountName" -}}
...
*/}}
{{- define "tempo.crossplane.azure.resourceGroup" -}}
...
*/}}
{{- define "tempo.crossplane.azure.isPrivateCluster" -}}
{{- $clusterName := .Values.crossplane.clusterName -}}
{{- $isPrivate := false -}}
...
*/}}
{{- define "tempo.crossplane.azure.vnetName" -}}
{{- $clusterName := .Values.crossplane.clusterName -}}
{{- $clusterNamespace := .Values.crossplane.clusterNamespace -}}
{{- $vnetName := "" -}}
{{- $azureCluster := lookup "infrastructure.cluster.x-k8s.io/v1beta1" "AzureCluster" $clusterNamespace $clusterName -}}
...
*/}}
{{- define "tempo.crossplane.azure.subnetName" -}}
{{- $clusterName := .Values.crossplane.clusterName -}}
{{- $clusterNamespace := .Values.crossplane.clusterNamespace -}}
{{- $subnetName := "" -}}
{{- $azureCluster := lookup "infrastructure.cluster.x-k8s.io/v1beta1" "AzureCluster" $clusterNamespace $clusterName -}}
...
*/}}
{{- define "tempo.crossplane.azure.vnetId" -}}
{{- $clusterName := .Values.crossplane.clusterName -}}
{{- $clusterNamespace := .Values.crossplane.clusterNamespace -}}
{{- $vnetId := "" -}}
{{- $azureCluster := lookup "infrastructure.cluster.x-k8s.io/v1beta1" "AzureCluster" $clusterNamespace $clusterName -}}
